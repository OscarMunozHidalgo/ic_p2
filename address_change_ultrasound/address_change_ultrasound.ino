...
#define SRF02_I2C_ADDRESS byte((0xE8)>>1)
...
void loop() 
{
  ...
  write_command(SRF02_I2C_ADDRESS,0xA0);
  //delay(SRF02_RANGING_DELAY);

  write_command(SRF02_I2C_ADDRESS,0xAA);
  //delay(SRF02_RANGING_DELAY);

  write_command(SRF02_I2C_ADDRESS,0xA5);
  //delay(SRF02_RANGING_DELAY);

  write_command(SRF02_I2C_ADDRESS,0xE4);
  //delay(SRF02_RANGING_DELAY);
